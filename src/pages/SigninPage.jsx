    ...
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black py-12 px-4">
        ...
        <button
          ...
          className="back-btn absolute top-6 left-6 md:top-8 md:left-8 z-20 flex items-center gap-2 text-[#c9a962] hover:text-[#f4e4bc] transition-colors cursor-pointer bg-transparent border-0"
        >
          ...
          >
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-yellow-700/30 bg-transparent accent-[#c9a962] cursor-pointer"
                  />
                  <span className="text-gray-400">Remember me</span>
                </label>
                <button type="button" onClick={() => console.log('Forgot password')} className="text-[#c9a962] hover:text-[#f4e4bc] transition-colors bg-transparent border-0 cursor-pointer">
                  Forgot password?
                </button>
              </div>
            ...
            <p className="text-center text-gray-400 text-sm mt-8">
              ...
              <button
                ...
                className="text-[#c9a962] hover:text-[#f4e4bc] transition-colors font-medium bg-transparent border-0 cursor-pointer"
              >
                Create one here
              </button>
            </p>
